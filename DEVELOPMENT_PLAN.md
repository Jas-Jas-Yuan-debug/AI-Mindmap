...
**Phase 6 status: 2/4 criteria met.** Open: save/load hierarchy (sibling C), undo reparent (sibling C). Foundation (GroupNode render + reparent + cycle guard) in PR #35; drag in/out + group-move + nested groups in PR #36.
