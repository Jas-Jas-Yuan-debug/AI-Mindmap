...
**Phase 6 status: 1/4 criteria met.** Open: nested groups (sibling B), save/load hierarchy (sibling C), undo reparent (sibling C). Foundation (GroupNode render + reparent + cycle guard) in PR #35.
